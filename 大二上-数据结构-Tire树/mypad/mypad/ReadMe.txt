================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : mypad Project Overview
===============================================================================

The application wizard has created this mypad application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your mypad application.
...
res\mypad.ico
    ...
    icon is included by the main resource file mypad.rc.
...
mypadDlg.h, mypadDlg.cpp - the dialog
    These files contain your CMypadDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in mypad.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CmypadDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named mypad.pch and a precompiled types file named StdAfx.obj.
